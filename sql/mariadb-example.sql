...
,(NULL, 'example.com', 'ns1', 'A', '8.8.8.8', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', 'ns2', 'A', '8.8.4.4', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', 'ns', 'CNAME', 'ns1.example.com.', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', '_domain._tcp', 'SRV', '0 50 53 ns1.example.com.', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', '_domain._tcp', 'SRV', '0 50 53 ns2.example.com.', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', '_domain._udp', 'SRV', '0 50 53 ns1.example.com.', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
,(NULL, 'example.com', '_domain._udp', 'SRV', '0 50 53 ns2.example.com.', NULL, NULL, NULL, 'SYSTEM', SYSDATE(), 'SYSTEM', SYSDATE(), 'N', NULL, NULL)
;
